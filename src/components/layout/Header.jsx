    ...
    <header className="sticky top-0 z-50 w-full h-16 border-b border-slate-200 bg-white shadow-sm">
      <div className="mx-auto h-full px-4 lg:px-8">
        <div className="flex h-16 items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-4 min-w-0 flex-1 lg:w-[52%] lg:flex-none">
            {/* Mobile Menu Toggle */}
            <button 
            ...
            {/* Desktop Navigation */}
            <div className="hidden lg:flex items-center gap-2 min-w-0 border-l border-slate-200 pl-4">
              {navItems.map(item => (
                <Link
                  key={item.path}
                  to={item.path}
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-2 px-3 py-2 rounded-lg text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition-all"
                >
                  <BarChart3 size={20} />
          ...
          {/* MIDDLE SECTION: Search Bar - Flexible, centered, limited width */}
          ...
          {/* RIGHT SECTION: Actions & Profile - Prevent compression */}
          <div className="flex items-center justify-end gap-4 shrink-0 lg:w-[22%]">
          ...
          {isMobileMenuOpen && (
            ...
            >
              ...
              <div className="px-4 pb-3 border-b border-slate-200">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="Tim kiem..."
                    className="w-full pl-9 pr-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-900 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-teal-500/40 text-sm"
                  />
                </div>
              </div>
              ...
              <div className="pt-2 border-t border-slate-200">
                <button
                  onClick={() => setIsAnalyticsOpen(!isAnalyticsOpen)}
                  className="w-full flex items-center justify-between px-4 py-2 text-slate-700 hover:bg-slate-100 rounded-lg transition-all"
                >
              ...
              <div className="pt-2 border-t border-slate-200 space-y-2">
                ...
                <button
                  onClick={handleLogout}
                  className="flex items-center space-x-3 px-4 py-3 text-rose-400 hover:bg-rose-500/10 rounded-lg transition-all w-full"
                >
                  <LogOut size={18} />
                  <span>Đăng xuất</span>
                </button>
